(function(window){
    function define_library() {
        ...
        vanillaZoom.init = function(el) {
            ...
            var zx = document.querySelector(el);
            if(!zx) {
                console.error('No container element. Please make sure you are using the right markup.');
                return;
            }

            var firstSmallImage = zx.querySelector('.small-preview');
            var zoomedImage = zx.querySelector('.zoomed-image');
            ...
            zx.addEventListener("click", function (event) {
